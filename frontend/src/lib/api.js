...
const mockData = {
  ...
  subCategoryProducts: [
    ...
    { id: 'scb-ssb1-008', imageUrl: '/images/heats/aim4.png', brand: 'Wartech', name: 'Административный подсумок Wartech', price: 1500, productLink: '/catalog/equipment/pouches/scb-ssb1-008', CATALOG_AVAILABLE: 'Y', category: 'equipment', subCategory: 'pouches' },
