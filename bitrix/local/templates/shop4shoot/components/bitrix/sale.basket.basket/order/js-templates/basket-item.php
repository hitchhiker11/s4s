													...
													<div class="basket-item-property basket-item-property-scu-image"
														...
														<div class="basket-item-property-value">
															<ul class="basket-item-scu-list">
																{{#SKU_VALUES_LIST}}
                                {{#SELECTED}}
																	<li class="k1-test basket-item-scu-item{{#SELECTED}} selected{{/SELECTED}}
...
<!--													</div>-->
			...
			{
				?>
<!--				<td class="basket-items-list-item-price basket-items-list-item-price-for-one--><?php //=(!isset($mobileColumns['PRICE']) ? ' hidden-xs' : '')?><!--">-->
...
<!--				</td>-->
        ...
        <span>В наличие {{AVAILABLE_QUANTITY}}</span>
