<?php if (!defined('B_PROLOG_INCLUDED') || B_PROLOG_INCLUDED !== true) die();
  ...
  if (empty($arResult['ERROR_MESSAGE'])) {
    ...
    <div id="basket-root" class="bx-basket bx-<?= $arParams['TEMPLATE_THEME'] ?> bx-step-opacity"
      ...
      <div class="body cart-body-height">
        <table class="main-table mobile-breakpad-break">
          <tr>
            <td class="left-p col-md-8 col-xs-12">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <div
                    class="basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?= $displayModeClass ?>"
                    ...
                    <div class="basket-items-list-container" id="basket-items-list-container">
                      ...
                      <div class="basket-items-list" id="basket-item-list">
                        ...
                        <table class="basket-items-list-table k1-test" id="basket-item-table"></table>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  $this->EndViewTarget();
  $APPLICATION->SetTitle("Ваш заказ готов к оформлению");
