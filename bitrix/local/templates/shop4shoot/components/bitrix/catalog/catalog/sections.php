...
<?php global $KRAKEN_TEMPLATE_ARRAY; ?>

<?php
  $header_back = "";
  
  if ($KRAKEN_TEMPLATE_ARRAY["CTLG_BG_PIC"]["VALUE"] > 0) {
...
//  }
?>
<?php \Bitrix\Main\Page\Frame::getInstance()->startDynamicWithID("sections-sections-list"); ?>
<?php
...
<?php $GLOBALS["KRAKEN_CURRENT_SECTION_ID"] = 0; ?>
<?php $GLOBALS["KRAKEN_CURRENT_DIR"] = "main"; ?>
<?php \Bitrix\Main\Page\Frame::getInstance()->finishDynamicWithID("sections-sections-list"); ?>
...
<?php
  ...
  echo "/upload/resize_cache/kraken/7d8/2560_1500_1/e9aul9z5prariv2myl5uh2sfud15zmzo.png";
  $this->EndViewTarget();
