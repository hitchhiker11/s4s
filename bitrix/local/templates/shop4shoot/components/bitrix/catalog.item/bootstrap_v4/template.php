...
if (isset($arResult['ITEM']))
{
  ...
  $styleString = "";
//  if ($_SERVER["REMOTE_ADDR"] === "178.155.4.56" || $_SERVER["HTTP_DDG_CONNECTING_IP"] === "178.155.4.56") {
    $styleString = "grid-area:P" . $arParams["kCount"] .= "P";
    if ($arParams["isGOAT"] === "Y") $styleString = "grid-area:G";
//  }
	?>

	<div style="<?= $styleString?>" class="product-item-container<?=(isset($arResult['SCALABLE']) && $arResult['SCALABLE'] ===
  'Y' ? ' product-item-scalable-card' : '')?>"
