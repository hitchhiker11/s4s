...
<div class="product-item <?= $stickerClass?>">
	...
	<?php endif; ?>
      ...
      ?>
		...
		<span class="product-item-image-original" id="<?= $itemIds['PICT'] ?>"
          style="background-image: url('<?= $item['DETAIL_PICTURE']['SRC'] ?>'); <?= ($showSlider ? 'display: none;' : '') ?>"></span>
		<?php
      if ($item['SECOND_PICT']) {
                  ...
                  if (!$haveOffers) {
                    if ($actualItem['CAN_BUY']) {
                      ...
                      <div class="product-item-button-container" id="<?= $itemIds['BASKET_ACTIONS'] ?>">
                        ...
                        <!--                          <a class="link-def" style="font-size: 14px;" href="-->
                        <?php //= $item["DETAIL_PAGE_URL"] ?><!--"-->
                        <!--                             id="--><?php //= $itemIds["BTN2DETAIL"] ?><!--">-->
                      ...
                      <div class="product-item-button-container">
                        ...
                        ?>
                        <!--                        <button class=" button-def main-color elips -->
                        <?php //= $buttonSizeClass ?><!--"-->
                        <!--                                id="-->
                        <?php //= $itemIds['NOT_AVAILABLE_MESS'] ?><!--" href="javascript:void(0)" rel="nofollow">-->
