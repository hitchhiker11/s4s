        ...
        <div class="descriptive">
          <div class="descriptive-table">
            <div class="descriptive-cell text-part z-text col-lg-12 col-md-12 col-sm-12 col-xs-12" style="">
              <div class="">
                <div class="text-wrap text-content dark                        left                        left-mob">
                  <ul>
                    <li>Телефон: 8 800 250-11-01</li>
                    <li>Телефон: +7 (915) 260-20-18</li>
                    <li>Почта: <a href="mainto:shop@weapon-culture.ru">shop@weapon-culture.ru</a></li>
                  </ul>
                </div>
              </div>
            </div>
