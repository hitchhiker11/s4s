...
return [
    'GET' => [
        'basket' => [
            'description' => 'Получение содержимого корзины или проверка наличия товара',
            ...
            'parameters' => [
                'action' => [
                    'type' => 'string',
                    'possibleValue' => ['get_basket', 'check_stock'],
                    'description' => 'Тип операции: get_basket (по умолчанию) или check_stock'
                ],
                'fuser_id' => [
                    'type' => 'integer',
                ...
                'product_id' => [
                    'type' => 'integer',
                    'description' => 'ID товара для проверки (для action=check_stock)'
                ],
                'quantity' => [
                    'type' => 'integer',
                    'description' => 'Количество для проверки (для action=check_stock)'
                ]
            ]
        ]
    ],
